...
latex_documents = [
    (master_doc, "DjangoJET.tex", "Django JET Documentation", "Denis Kildishev", "manual"),
]
...
man_pages = [(master_doc, "djangojet", "Django JET Documentation", [author], 1)]
