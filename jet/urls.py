...
urlpatterns = [
    ...
    re_path(r"^toggle_application_pin/$", toggle_application_pin_view, name="toggle_application_pin"),
    re_path(r"^model_lookup/$", model_lookup_view, name="model_lookup"),
    re_path(r"^jsi18n/$", javascript_catalog, {"packages": "django.contrib.admin+jet"}, name="jsi18n"),
]
